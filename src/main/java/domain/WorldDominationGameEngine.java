...
public final class WorldDominationGameEngine {
    ...
    private void storeRecentlyAttackedTerritories(TerritoryType source, TerritoryType dest) {
        this.recentlyAttackedSource = source;
        this.recentlyAttackedDestination = dest;
    }
